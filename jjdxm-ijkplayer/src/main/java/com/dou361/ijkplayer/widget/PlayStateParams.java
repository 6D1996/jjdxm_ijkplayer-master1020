...
public class PlayStateParams {
     ...
     * 准备中/加载中
     */
    public static final int STATE_PREPARING = 332;  //等于真正缓冲中时sendmessage好用，不等于时不好用，它自己单独的时候也一样不好用
    /**
     * 准备完成
     */
    public static final int STATE_PREPARED = 333; //不能加 加完暂停键变了
    /**
     * 播放中
     */
    public static final int STATE_PLAYING = 334;//处在播放中不发，不出在播放中时发
    /**
     * 暂停
     */
